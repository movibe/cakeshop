	...
	<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo $this->Html->url('/'); ?>"><?php echo Configure::read('Settings.SHOP_TITLE') ?></a>
			</div>
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<ul class="navbar-form form-inline navbar-right">
					...
					<?php echo $this->Html->link(__('Shopping Cart'), array('controller' => 'shop', 'action' => 'cart'), array('class' => 'btn btn-sm btn-success')); ?>
					</span>
